  ...
  return (
    <div className="login">
      <div className="holder">
        ...
        <br />
        <form>
          <input className="form-control" value={email} onChange={emailOnChangeHandler} type="email"
            placeholder="Email"/>
          ...
          <button
            className="btn btn-danger btn-block" onClick={ctaClickHandler} >
          ...
          {page && (
            <div className="form-check">
              ...
              <label
                className="form-check-label text-white" htmlFor="flexCheckDefault">
                Remember Me
              </label>
            </div>
          )}
        ...
        <br />
        {isUserExist && (
          <p className="text-danger">User does not exist | Click Signup</p>
        )}
        {isEmailUsed && (
          <p className="text-danger">Email Already Registered | Click Sign In</p>
        )}
